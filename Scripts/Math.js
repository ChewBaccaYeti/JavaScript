...
function acosh() {
    ...
    const HYPERBOLA = [`w=${w}`, ` x=${x}`, ` y=${y}`, ` z=${z}`];
...
function atan() {
    ...
    const ARCTANGENT = [`w:${w}`, ` x:${x}`, ` y:${y}`, ` z:${z}`];
...
function atan2() {
    ...
    const ARCTANGENT2 = [`w=${w}`, ` x=${x}`, ` y=${y}`, ` z=${z}`];
...
function fround() {
    let a = Math.fround(2.6);
    let b = Math.fround(2.5);
    let c = Math.fround(2.49);
    let d = Math.fround(-2.6);
    let e = Math.fround(-2.5);
